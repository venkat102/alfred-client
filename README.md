...
| **[API Reference](docs/developer-api.md)** | Developers | REST API, WebSocket protocol, 14 MCP tools, reflection, tracing, state machine internals |
